...
def process_groups(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Verarbeitet die Gruppen und fügt baudatuuid-Einträge hinzu.
    """
    ...
    for idx, gruppe in enumerate(output_data["Gruppen"], 1):
        ...
        matched_uuids = matcher.match_material(
        ...
        # UUIDs hinzufügen
        gruppe["baudatuuid"] = matched_uuids
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='EPD Matcher - Verarbeitet Bauschichten und fügt Baudaten-UUIDs hinzu'
    )
